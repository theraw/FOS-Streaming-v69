...
ffmpeg()
{
    wget http://johnvansickle.com/ffmpeg/releases/ffmpeg-release-i686-static.tar.xz -O /home/fos-streaming/ffmpeg-release-i686-static.tar.xz > /dev/null 2>&1
    tar -xJf /home/fos-streaming/ffmpeg-release-i686-static.tar.xz -C /tmp/ > /dev/null 2>&1
