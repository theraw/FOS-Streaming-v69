                            ...
                            <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="password" class="form-control col-md-7 col-xs-12"
                                               value="{{  isset($_POST['password']) ?  $_POST['password'] : $user->password}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="expdate" id="expdate"
                                               class="date-picker form-control col-md-7 col-xs-12" id="date01"
                                               placeholder="0000-00-00"
                                               value="{{  isset($_POST['expdate']) ?  $_POST['expdate'] : $user->exp_date }}">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Max
                                        connection</label>
                                    <div class="col-md-1">
                                        <input type="number" name="limit" class="form-control col-md-7 col-xs-12"
                                               value="{{  isset($_POST['limit']) ?  $_POST['limit'] : $user->max_connections ? $user->max_connections : 1}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <p style="padding: 5px;"><span><input type="checkbox" class="flat" name="active"
                                                                              id=""
                                                                              value="1" {{ $user->active ? "checked" : ""}}></span>
                                        </p>
                                    </div>
                                </div>
